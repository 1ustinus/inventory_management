...
export async function seedInitialData() {
  ...
  const sampleProducts = [
    { name: "Purefoods Corned Beef 150g", price: 65, costPrice: 48, stock: 50, category: "Canned Goods", image: "https://picsum.photos/seed/beef/200/200" },
    { name: "Coke Original 1.5L", price: 75, costPrice: 62, stock: 24, category: "Beverages", image: "https://picsum.photos/seed/beverage1/200/200" },
    { name: "Pancit Canton Extra Hot", price: 18, costPrice: 14, stock: 120, category: "Instant Noodles", image: "https://picsum.photos/seed/noodles/200/200" },
    { name: "Gardenia Classic Loaf", price: 85, costPrice: 72, stock: 12, category: "Bread & Bakery", minStock: 15, image: "https://picsum.photos/seed/bread/200/200" },
    { name: "Kopiko Lucky Day", price: 25, costPrice: 20, stock: 48, category: "Beverages", image: "https://picsum.photos/seed/coffee/200/200" },
    { name: "San Miguel Pale Pilsen 320ml", price: 55, costPrice: 45, stock: 36, category: "Beverages", image: "https://picsum.photos/seed/beer/200/200" },
    { name: "Safeguard White 130g", price: 45, costPrice: 38, stock: 30, category: "Toiletries", image: "https://picsum.photos/seed/soap/200/200" },
